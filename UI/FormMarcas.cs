...
namespace UI
{
    public partial class FormMarcas : Form
    {
        ...
        private void buttonEditar_Click(object sender, EventArgs e)
        {
            ...
            string respuesta = "";
            respuesta = logicaMarca.EditarMarca(textBoxNombre.Text, textBoxDescripcion.Text, Convert.ToByte(checkBoxEstado.CheckState), id);
            MessageBox.Show(respuesta);
            dataGridView1.DataSource = logicaMarca.ListarMarcasActivas();
        ...
        {
            dataGridView1.DataSource = logicaMarca.ListarMarcasInactivas();
            dataGridView1.Refresh();
        }
        ...
        private void buttonGuardar_Click(object sender, EventArgs e)
        {
            ...
            string respuesta = "";
            respuesta = logicaMarca.NuevaMarca(textBoxNombre.Text, textBoxDescripcion.Text);
            MessageBox.Show(respuesta);
            textBoxNombre.Text = "";
            textBoxDescripcion.Text = "";
            dataGridView1.DataSource = logicaMarca.ListarMarcasActivas();
